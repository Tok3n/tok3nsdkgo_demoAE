...
["OxxoBanamex", "package:OxxoBanamex/paypalinterface.dart", , O, {
  "^": "",
  PartialLoader_getLoginPartial: function(ele) {
    var t1, cmpl;
    t1 = W.Element;
    cmpl = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [t1])), [t1]);
    W.HttpRequest_getString("partials/loginpartial.html", null, null).then$1(new O.PartialLoader_getLoginPartial_closure(ele, cmpl));
    return cmpl.future;
  },
  OxxoLoader: {
    "^": "Object;img",
    initted$1: [function(response) {
      var sqrl = M.SQRL$("d550667e-a85b-5e95-5a93-cd0645853f6a", J.$index$asx(C.JsonCodec_null_null.decode$1(response), "Tok3nKey"), "auth");
      sqrl.init_doneC.future.then$1(new O.OxxoLoader_initted_closure(this, sqrl));
      sqrl.qr_conectedC.future.then$1(this.get$validatedQR());
    }, "call$1", "get$initted", 2, 0, 13, 38],
    validatedQR$1: [function(response) {
      W.HttpRequest_getString("/ws/getdata", null, null).then$1(new O.ShowData().get$dataLoaded());
    }, "call$1", "get$validatedQR", 2, 0, 13, 38],
    OxxoLoader$0: function() {
      var container, div;
      container = document.querySelector("body");
      div = W.Element_Element$html("<div>\n  <table>\n    <tr>\n      <td>\n        Escanear el codigo para sincronizar\n      </td>\n    </tr>\n    <tr>\n      <td>\n        <img id=\"imagen\" />\n      </td>\n    </tr>\n  </table>\n</div>\n", null, null);
      J._clearChildren$0$x(container);
      container.appendChild(div);
      this.img = J.querySelector$1$x(div, "#imagen");
      W.HttpRequest_getString("/ws/getuser", null, null).then$1(this.get$initted());
    },
    static: {OxxoLoader$: function() {
        var t1 = new O.OxxoLoader(null);
        t1.OxxoLoader$0();
        return t1;
      }}
  },
  OxxoLoader_initted_closure: {
    "^": "Closure:33;this_0,sqrl_1",
    call$1: [function(_) {
      var t1 = this.this_0;
      J.set$width$x(t1.img, 280);
      J.set$src$x(t1.img, this.sqrl_1.getQR_URL$1$ForLogin(false));
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  ShowData: {
    "^": "Object;",
    dataLoaded$1: [function(result) {
      var data, container, t1, div;
      P.print(result);
      data = C.JsonCodec_null_null.decode$1(result);
      container = document.querySelector("body");
      t1 = J.getInterceptor$asx(data);
      div = W.Element_Element$html("<div>\n  <table>\n\n    <tr>\n      <td>\n        Nombre:\n      </td>\n      <td>\n        " + H.S(t1.$index(data, "Nombre")) + "\n      </td>\n    </tr>\n\n    <tr>\n      <td>\n        Direccion:\n      </td>\n      <td>\n        " + H.S(t1.$index(data, "Direccion")) + "\n      </td>\n    </tr>\n\n    <tr>\n      <td>\n        Telefono:\n      </td>\n      <td>\n        " + H.S(t1.$index(data, "Telefono")) + "\n      </td>\n    </tr>\n\n    <tr>\n      <td>\n        <input type=\"button\" value=\"Siguiente...\" id=\"siguiente\" />\n      </td>\n    </tr>\n  </table>\n</div>\n", null, null);
      J._clearChildren$0$x(container);
      container.appendChild(div);
      t1 = J.get$onClick$x(J.querySelector$1$x(div, "#siguiente"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(this.get$siguienteclick()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }, "call$1", "get$dataLoaded", 2, 0, 40, 41],
    siguienteclick$1: [function(_) {
      O.OxxoLoader$();
    }, "call$1", "get$siguienteclick", 2, 0, 13, 39]
  },
  Calculator: {
    "^": "Object;text",
    add$1: function(_, num) {
      var n, f;
      n = J.$div$n(J.$add$ns(J.$mul$ns(H.Primitives_parseDouble(J.replaceAll$2$s(J.get$value$x(this.text), "$", ""), null), 1000), num), 100);
      f = T.NumberFormat_NumberFormat("###.0#", "en_US");
      J.set$value$x(this.text, "$" + H.S(f.format$1(0, n)));
    },
    getQR$1: [function(_) {
      W.HttpRequest_getString("/ws/setmonto?monto=" + H.S(J.get$value$x(this.text)), null, null).then$1(new O.Calculator_getQR_closure(this));
    }, "call$1", "get$getQR", 2, 0, 13, 39],
    cancel$1: [function(_) {
      J.set$value$x(this.text, "$0");
    }, "call$1", "get$cancel", 2, 0, 13, 39],
    Calculator$0: function() {
      var container, div, t1, t2;
      container = document.querySelector("body");
      ...
      this.text = t1.querySelector$1(div, "#text");
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#next"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(this.get$getQR()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#cancel"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(this.get$cancel()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton0"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton1"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton2"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure1(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton3"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure2(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton4"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure3(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton5"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure4(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton6"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure5(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton7"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure6(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton8"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.Calculator_closure7(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = J.get$onClick$x(t1.querySelector$1(div, "#boton9"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new O.Calculator_closure8(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {Calculator$: function() {
        var t1 = new O.Calculator(null);
        t1.Calculator$0();
        return t1;
      }}
  },
  ...
  Calculator_closure8: {
    "^": "Closure:33;this_9",
    call$1: [function(_) {
      return this.this_9.add$1(0, 9);
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  Calculator_getQR_closure: {
    "^": "Closure:33;this_0",
    call$1: [function(_) {
      var t1, t2;
      t1 = J.get$value$x(this.this_0.text);
      t2 = new O.Calculadora2(t1, null);
      t2.Calculadora2$1(t1);
      return t2;
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  Calculadora2: {
    ...
    initted$1: [function(response) {
      var sqrl = M.SQRL$("d550667e-a85b-5e95-5a93-cd0645853f6a", J.$index$asx(C.JsonCodec_null_null.decode$1(response), "Tok3nKey"), "auth");
      sqrl.init_doneC.future.then$1(new O.Calculadora2_initted_closure(this, sqrl));
      sqrl.qr_conectedC.future.then$1(this.get$validatedQR());
    }, "call$1", "get$initted", 2, 0, 13, 38],
    validatedQR$1: [function(response) {
      O.Calculator$();
    }, "call$1", "get$validatedQR", 2, 0, 13, 38],
    Calculadora2$1: function(amount) {
      var container, div;
      container = document.querySelector("body");
      div = W.Element_Element$html("<div>\n  <table>\n    <tr>\n      <td>\n        <input type=\"text\" id=\"text\" value=\"" + H.S(this.amount) + "\" />\n      </td>\n    </tr>\n    <tr>\n      <td>\n        <img id=\"imagen\" />\n      </td>\n    </tr>\n  </table>\n</div>\n", null, null);
      J._clearChildren$0$x(container);
      container.appendChild(div);
      this.img = J.querySelector$1$x(div, "#imagen");
      W.HttpRequest_getString("/ws/getuser", null, null).then$1(this.get$initted());
  ...
  PartialLoader_getLoginPartial_closure: {
    "^": "Closure:33;ele_0,cmpl_1",
    call$1: [function(r) {
      var t1 = this.ele_0;
      J._clearChildren$0$x(t1);
      t1.appendChild(W.Element_Element$html(r, new O.NullTreeSanitizer(), null));
      this.cmpl_1.complete$1(0, t1);
    }, "call$1", null, 2, 0, null, 42, "call"],
    $isFunction: true
  },
  PayPalManager: {
    "^": "Object;foroxxo",
    Tok3nVinculation$0: function() {
      W.HttpRequest_getString("/ws/userHasTok3n", null, null).then$1(new O.PayPalManager_Tok3nVinculation_closure(this));
    },
    showCalculator$1: [function(_) {
      if (this.foroxxo)
        O.OxxoLoader$();
      else
        O.Calculator$();
    }, "call$1", "get$showCalculator", 2, 0, 13, 39],
    PayPalManager$1$forOxxo: function(forOxxo) {
      this.foroxxo = forOxxo;
      W.HttpRequest_getString("/ws/isloggedin", null, null).then$1(new O.PayPalManager_closure(this));
    },
    static: {PayPalManager$: function(forOxxo) {
        var t1 = new O.PayPalManager(false);
        t1.PayPalManager$1$forOxxo(forOxxo);
        return t1;
      }}
  },
  PayPalManager_closure: {
    "^": "Closure:3;this_0",
    call$1: [function(resp) {
      if (J.$eq(resp, "YES")) {
        this.this_0.Tok3nVinculation$0();
        P.print("logged in");
      } else
        O.LoginWindow$();
  ...
  PayPalManager_Tok3nVinculation_closure: {
    "^": "Closure:3;this_0",
    call$1: [function(resp) {
      var tok3n;
      if (J.$eq(resp, "YES")) {
        tok3n = new O.ShowTok3nWindow(null, null, null);
        tok3n.ShowTok3nWindow$0();
        tok3n.cmpl.future.then$1(this.this_0.get$showCalculator());
      } else
        new O.MergeTok3nWindow(null, null).MergeTok3nWindow$0();
    }, "call$1", null, 2, 0, null, 43, "call"],
    $isFunction: true
  },
  LoginWindow: {
    "^": "Object;",
    createAccount$1: function(ele) {
      var e, t1;
      e = J.querySelector$1$x(ele, "#username");
      t1 = J.getInterceptor$x(e);
      if (J.get$length$asx(t1.get$value(e)) > 3)
        W.HttpRequest_getString("/ws/create?user=" + H.S(t1.get$value(e)), null, null).then$1(new O.LoginWindow_createAccount_closure(this, ele));
    },
    loginAccount$1: function(ele) {
      var e, t1;
      e = J.querySelector$1$x(ele, "#username");
      t1 = J.getInterceptor$x(e);
      if (J.get$length$asx(t1.get$value(e)) > 3)
        W.HttpRequest_getString("/ws/login?user=" + H.S(t1.get$value(e)), null, null).then$1(this.get$loginAccount_response());
    },
    loginAccount_response$1: [function(response) {
      if (J.$eq(response, "OK")) {
        P.print("loggedin");
        window.location.reload();
      } else
        P.print("not loggedin");
    }, "call$1", "get$loginAccount_response", 2, 0, 13, 38],
    LoginWindow$0: function() {
      P.print("init loginwindow");
      O.PartialLoader_getLoginPartial(document.querySelector("#container")).then$1(new O.LoginWindow_closure(this));
    },
    static: {LoginWindow$: function() {
        var t1 = new O.LoginWindow();
        t1.LoginWindow$0();
        return t1;
      }}
  },
  LoginWindow_closure: {
    ...
    call$1: [function(ele) {
      ...
      t2 = J.get$onClick$x(t1.querySelector$1(ele, "#loginbutton"));
      t3 = this.this_0;
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.LoginWindow__closure(t3, ele)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = J.get$onClick$x(t1.querySelector$1(ele, "#createbutton"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new O.LoginWindow__closure0(t3, ele)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }, "call$1", null, 2, 0, null, 44, "call"],
    $isFunction: true
  },
  LoginWindow__closure: {
    "^": "Closure:33;this_1,ele_2",
    call$1: [function(_) {
      return this.this_1.loginAccount$1(this.ele_2);
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  LoginWindow__closure0: {
    "^": "Closure:33;this_3,ele_4",
    call$1: [function(_) {
      return this.this_3.createAccount$1(this.ele_4);
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  LoginWindow_createAccount_closure: {
    "^": "Closure:3;this_0,ele_1",
    call$1: [function(response) {
      if (J.startsWith$1$s(response, "ERROR"))
        window.alert(response);
      else
        this.this_0.loginAccount$1(this.ele_1);
    }, "call$1", null, 2, 0, null, 38, "call"],
    $isFunction: true
  },
  ShowTok3nWindow: {
    "^": "Object;cmpl,client,script",
    inited$1: [function(response) {
      var data, t1;
      data = C.JsonCodec_null_null.decode$1(response);
      t1 = new A.Tok3nClient("d550667e-a85b-5e95-5a93-cd0645853f6a", null, document.querySelector("body"), null);
      this.client = t1;
      this.script = t1.askTok3n$1(J.$index$asx(data, "Tok3nKey"));
      this.client.responseC.future.then$1(this.get$complete(this));
    }, "call$1", "get$inited", 2, 0, 13, 38],
    complete$1: [function(_, response) {
      var t1, data;
      t1 = J.getInterceptor$x(response);
      data = C.JsonCodec_null_null.decode$1(t1.get$detail(response));
      P.print(data);
      if (J.$eq(J.$index$asx(data, "Valid"), "YES"))
        W.HttpRequest_getString("/ws/authenticateuser?q=" + H.S(P.Uri__uriEncode(C.List_KIf, t1.get$detail(response), C.Utf8Codec_false, false)), null, null).then$1(new O.ShowTok3nWindow_complete_closure(this, response));
    }, "call$1", "get$complete", 2, 0, 13, 38],
    ShowTok3nWindow$0: function() {
      P.print("login with tok3n");
      this.cmpl = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      W.HttpRequest_getString("/ws/getuser", null, null).then$1(this.get$inited());
    }
  },
  ShowTok3nWindow_complete_closure: {
    "^": "Closure:33;this_0,response_1",
    call$1: [function(_) {
      var t1, t2, t3;
      t1 = this.this_0;
      t2 = t1.client;
      t3 = t2.container;
      t3.toString;
      new W._ChildNodeListLazy(t3).remove$1(0, t2.element);
      t1.cmpl.complete$1(0, this.response_1);
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  MergeTok3nWindow: {
    "^": "Object;client,script",
    responded$1: [function(response) {
      var t1, data;
      t1 = J.getInterceptor$x(response);
      data = C.JsonCodec_null_null.decode$1(t1.get$detail(response));
      P.print(data);
      if (J.$eq(J.$index$asx(data, "Valid"), "YES"))
        W.HttpRequest_getString("/ws/authenticateuser?q=" + H.S(P.Uri__uriEncode(C.List_KIf, t1.get$detail(response), C.Utf8Codec_false, false)), null, null).then$1(new O.MergeTok3nWindow_responded_closure());
    }, "call$1", "get$responded", 2, 0, 46, 38],
    MergeTok3nWindow$0: function() {
      P.print("start vinculation of tok3n");
      var t1 = new A.Tok3nClient("d550667e-a85b-5e95-5a93-cd0645853f6a", null, document.querySelector("body"), null);
      this.client = t1;
      this.script = t1.addUser$0();
      this.client.responseC.future.then$1(this.get$responded());
    }
  },
  MergeTok3nWindow_responded_closure: {
    "^": "Closure:33;",
    call$1: [function(_) {
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.async", "dart:async", , P, {
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 55, 16, 17, 18]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
  ...
  _cancelAndErrorClosure_closure: {
    "^": "Closure:59;subscription_0,future_1",
    call$2: function(error, stackTrace) {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 61, 17, 18],
...
["dart.dom.html", "dart:html", , W, {
  ...
  Document: {
    ...
    get$onLoad: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, "load", false), [null]);
    },
  ...
  InputElement: {
    "^": "HtmlElement;name=,src},value%,width}",
    $isElement: true,
    $isNode: true,
    "%": "HTMLInputElement"
  },
...
["dart_node_tree_sanitizers", "package:dart_node_tree_sanitizers/dart_node_tree_sanitizers.dart", , O, {
  "^": "",
  NullTreeSanitizer: {
    "^": "Object;",
    sanitizeTree$1: function(node) {
...
["html_common", "dart:html_common", , P, {
  ...
  convertNativeToDart_AcceptStructuredClone_walk: {
    "^": "Closure:33;mustCopy_4,findSlot_5,readSlot_6,writeSlot_7",
    call$1: function(e) {
...
["intl", "package:intl/intl.dart", , T, {
  ...
  }, "call$1", "Intl__throwLocaleError$closure", 2, 0, 36],
  ...
  NumberFormat: {
    ...
    static: {NumberFormat_NumberFormat: function(newPattern, locale) {
      ...
      }, "call$1", "NumberFormat_localeExists$closure", 2, 0, 37]}
  },
  NumberFormat_NumberFormat_closure: {
    "^": "Closure:33;newPattern_0",
    call$1: function(x) {
...
["", "paypalinterface.dart", , U, {
  "^": "",
  main: [function() {
    O.PayPalManager$(false);
  }, "call$0", "main$closure", 0, 0, 12]
},
1],
["tok3n_dart", "package:Tok3n_Dart/tok3n_dart.dart", , A, {
  "^": "",
  Tok3nClient: {
    "^": "Object;publickey,element,container,responseC",
    addUser$0: function() {
      this.responseC = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      var t1 = W.Element_Element$html("<script src=\"//secure.tok3n.com/api_v2_iframe/tok3n.js\" \n  data-tok3n-integration\n  data-render-tag\n  data-tag-class-name=\"btn btn-success btn-lrg btn-block\"\n  action=\"authorize\"\n  public-key=\"" + this.publickey + "\">\n</script>\n", new O.NullTreeSanitizer(), null);
      this.element = t1;
      t1 = J.get$onLoad$x(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Tok3nClient_addUser_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$on$x(this.element).$index(0, "response");
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Tok3nClient_addUser_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      this.container.appendChild(this.element);
      return this.element;
    },
    askTok3n$1: function(userkey) {
      var t1;
      this.responseC = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      t1 = W.Element_Element$html("<script src=\"//secure.tok3n.com/api_v2_iframe/tok3n.js\" \n  data-tok3n-integration\n  data-render-tag\n  data-tag-class-name=\"btn btn-success btn-lrg btn-block\"\n  action=\"authenticate\"\n  public-key=\"" + this.publickey + "\"\n  user-key=\"" + H.S(userkey) + "\">\n</script>\n", new O.NullTreeSanitizer(), null);
      this.element = t1;
      t1 = J.get$onLoad$x(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Tok3nClient_askTok3n_closure(this, userkey)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$on$x(this.element).$index(0, "response");
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Tok3nClient_askTok3n_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      this.container.appendChild(this.element);
      return this.element;
    }
  },
  Tok3nClient_addUser_closure: {
    "^": "Closure:33;this_0",
    call$1: [function(_) {
      var t1 = J.get$onLoad$x(document.querySelector("#tok3n-iframe"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Tok3nClient_addUser__closure(this.this_0)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      J.set$display$x(document.querySelector("#tok3n-authenticate").style, "none");
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  Tok3nClient_addUser__closure: {
    "^": "Closure:33;this_1",
    call$1: [function(_) {
      P.print("antes de llamar");
      J.$index$asx($.get$context(), "Tok3n").callMethod$2("showIFrame", ["authorize", this.this_1.publickey, null]);
      P.print("despues de llamar");
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  Tok3nClient_addUser_closure0: {
    "^": "Closure:33;this_2",
    call$1: [function(r) {
      return this.this_2.responseC.complete$1(0, r);
    }, "call$1", null, 2, 0, null, 42, "call"],
    $isFunction: true
  },
  Tok3nClient_askTok3n_closure: {
    "^": "Closure:33;this_0,userkey_1",
    call$1: [function(_) {
      var t1 = J.get$onLoad$x(document.querySelector("#tok3n-iframe"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.Tok3nClient_askTok3n__closure(this.this_0, this.userkey_1)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      J.set$display$x(document.querySelector("#tok3n-authenticate").style, "none");
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  Tok3nClient_askTok3n__closure: {
    "^": "Closure:33;this_2,userkey_3",
    call$1: [function(_) {
      P.print("antes de llamar");
      J.$index$asx($.get$context(), "Tok3n").callMethod$2("showIFrame", ["authenticate", this.this_2.publickey, this.userkey_3]);
      P.print("despues de llamar");
    }, "call$1", null, 2, 0, null, 39, "call"],
    $isFunction: true
  },
  Tok3nClient_askTok3n_closure0: {
    "^": "Closure:33;this_4",
    call$1: [function(r) {
      return this.this_4.responseC.complete$1(0, r);
    }, "call$1", null, 2, 0, null, 42, "call"],
    $isFunction: true
  }
}],
["tok3napi_dart", "package:Tok3nAPI_Dart/tok3napi_dart.dart", , M, {
  "^": "",
  Tok3n_V2_getTransactionId: function(publicKey, kind, userKey) {
    var cmpl = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
    W.HttpRequest_getString($.Tok3n_V2_DOMAIN + "/api/v2/transaction.new?publicKey=" + publicKey + "&kind=" + kind + "&userKey=" + H.S(userKey), null, null).then$1(new M.Tok3n_V2_getTransactionId_closure(cmpl));
    return cmpl.future;
  },
  Tok3n_V2_QR_valid: function() {
    var cmpl = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
    W.HttpRequest_getString($.Tok3n_V2_DOMAIN + "/api/v2/sqrValid", null, true).then$1(new M.Tok3n_V2_QR_valid_closure(cmpl));
    return cmpl.future;
  },
  SQRL: {
    "^": "Object;ready,publicKey,userKey,kind,transactionID,init_doneC,qr_conectedC,cancelQR",
    init_response$1: [function(response) {
      if (J.startsWith$1$s(response, "ERRROR"))
        this.init_doneC.completeError$1(response);
      else {
        this.transactionID = response;
        this.init_doneC.complete$1(0, response);
      }
    }, "call$1", "get$init_response", 2, 0, 40, 38],
    getQR_URL$1$ForLogin: function(ForLogin) {
      var t1, url;
      P.print("the QR is been served");
      this.startQRRoutine$0();
      P.print("the QR has been started scanned");
      this.cancelQR = false;
      t1 = this.transactionID;
      url = $.Tok3n_V2_DOMAIN + "/api/v2/getQR?transaction=" + H.S(t1) + "&public_key=" + this.publicKey;
      return ForLogin ? url + "&forlogin=1" : url;
    },
    startQRRoutine$0: function() {
      P.print("previous timer");
      P.Timer_Timer(C.Duration_5000000, this.get$getDataFromQR());
      P.print("after timer");
    },
    getDataFromQR$0: [function() {
      P.print("validatingQR");
      M.Tok3n_V2_QR_valid().then$1(new M.SQRL_getDataFromQR_closure(this));
    }, "call$0", "get$getDataFromQR", 0, 0, 12],
    SQRL$3: function(publicKey, userKey, kind) {
      this.init_doneC = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      this.qr_conectedC = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      M.Tok3n_V2_getTransactionId(this.publicKey, this.kind, this.userKey).then$1(this.get$init_response());
    },
    static: {SQRL$: function(publicKey, userKey, kind) {
        var t1 = new M.SQRL(false, publicKey, userKey, kind, null, null, null, null);
        t1.SQRL$3(publicKey, userKey, kind);
        return t1;
      }}
  },
  SQRL_getDataFromQR_closure: {
    "^": "Closure:33;this_0",
    call$1: [function(response) {
      var d, t1;
      d = C.JsonCodec_null_null.decode$1(response);
      t1 = this.this_0;
      if (t1.cancelQR !== true) {
        P.print("not valid yet");
        if (J.$eq(J.$index$asx(d, "Valid"), "NO"))
          t1.startQRRoutine$0();
        else {
          P.print("VALID");
          t1.cancelQR = true;
          t1.qr_conectedC.complete$1(0, response);
        }
      }
    }, "call$1", null, 2, 0, null, 38, "call"],
    $isFunction: true
  },
  Tok3n_V2_getTransactionId_closure: {
    "^": "Closure:33;cmpl_0",
    call$1: [function(r) {
      P.Timer_Timer(C.Duration_100000, new M.Tok3n_V2_getTransactionId__closure(this.cmpl_0, r));
    }, "call$1", null, 2, 0, null, 42, "call"],
    $isFunction: true
  },
  Tok3n_V2_getTransactionId__closure: {
    "^": "Closure:49;cmpl_1,r_2",
    call$0: function() {
      return this.cmpl_1.complete$1(0, this.r_2);
    },
    $isFunction: true
  },
  Tok3n_V2_QR_valid_closure: {
    "^": "Closure:33;cmpl_0",
    call$1: [function(r) {
      return this.cmpl_0.complete$1(0, r);
    }, "call$1", null, 2, 0, null, 42, "call"],
    $isFunction: true
  }
}],
...
$.Tok3n_V2_DOMAIN = "http://secure.tok3n.com";
...
//# sourceMappingURL=paypalinterface.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function OxxoLoader(img) {
    this.img = img;
  }
  OxxoLoader.builtin$cls = "OxxoLoader";
  if (!"name" in OxxoLoader)
    OxxoLoader.name = "OxxoLoader";
  $desc = $collectedClasses.OxxoLoader;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OxxoLoader.prototype = $desc;
  function OxxoLoader_initted_closure(this_0, sqrl_1) {
    this.this_0 = this_0;
    this.sqrl_1 = sqrl_1;
  }
  OxxoLoader_initted_closure.builtin$cls = "OxxoLoader_initted_closure";
  if (!"name" in OxxoLoader_initted_closure)
    OxxoLoader_initted_closure.name = "OxxoLoader_initted_closure";
  $desc = $collectedClasses.OxxoLoader_initted_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OxxoLoader_initted_closure.prototype = $desc;
  function ShowData() {
  }
  ShowData.builtin$cls = "ShowData";
  if (!"name" in ShowData)
    ShowData.name = "ShowData";
  $desc = $collectedClasses.ShowData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ShowData.prototype = $desc;
  function Calculator(text) {
    this.text = text;
  }
  Calculator.builtin$cls = "Calculator";
  if (!"name" in Calculator)
    Calculator.name = "Calculator";
  $desc = $collectedClasses.Calculator;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator.prototype = $desc;
  function Calculator_closure(this_0) {
    this.this_0 = this_0;
  }
  Calculator_closure.builtin$cls = "Calculator_closure";
  if (!"name" in Calculator_closure)
    Calculator_closure.name = "Calculator_closure";
  $desc = $collectedClasses.Calculator_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure.prototype = $desc;
  function Calculator_closure0(this_1) {
    this.this_1 = this_1;
  }
  Calculator_closure0.builtin$cls = "Calculator_closure0";
  if (!"name" in Calculator_closure0)
    Calculator_closure0.name = "Calculator_closure0";
  $desc = $collectedClasses.Calculator_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure0.prototype = $desc;
  function Calculator_closure1(this_2) {
    this.this_2 = this_2;
  }
  Calculator_closure1.builtin$cls = "Calculator_closure1";
  if (!"name" in Calculator_closure1)
    Calculator_closure1.name = "Calculator_closure1";
  $desc = $collectedClasses.Calculator_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure1.prototype = $desc;
  function Calculator_closure2(this_3) {
    this.this_3 = this_3;
  }
  Calculator_closure2.builtin$cls = "Calculator_closure2";
  if (!"name" in Calculator_closure2)
    Calculator_closure2.name = "Calculator_closure2";
  $desc = $collectedClasses.Calculator_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure2.prototype = $desc;
  function Calculator_closure3(this_4) {
    this.this_4 = this_4;
  }
  Calculator_closure3.builtin$cls = "Calculator_closure3";
  if (!"name" in Calculator_closure3)
    Calculator_closure3.name = "Calculator_closure3";
  $desc = $collectedClasses.Calculator_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure3.prototype = $desc;
  function Calculator_closure4(this_5) {
    this.this_5 = this_5;
  }
  Calculator_closure4.builtin$cls = "Calculator_closure4";
  if (!"name" in Calculator_closure4)
    Calculator_closure4.name = "Calculator_closure4";
  $desc = $collectedClasses.Calculator_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure4.prototype = $desc;
  function Calculator_closure5(this_6) {
    this.this_6 = this_6;
  }
  Calculator_closure5.builtin$cls = "Calculator_closure5";
  if (!"name" in Calculator_closure5)
    Calculator_closure5.name = "Calculator_closure5";
  $desc = $collectedClasses.Calculator_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure5.prototype = $desc;
  function Calculator_closure6(this_7) {
    this.this_7 = this_7;
  }
  Calculator_closure6.builtin$cls = "Calculator_closure6";
  if (!"name" in Calculator_closure6)
    Calculator_closure6.name = "Calculator_closure6";
  $desc = $collectedClasses.Calculator_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure6.prototype = $desc;
  function Calculator_closure7(this_8) {
    this.this_8 = this_8;
  }
  Calculator_closure7.builtin$cls = "Calculator_closure7";
  if (!"name" in Calculator_closure7)
    Calculator_closure7.name = "Calculator_closure7";
  $desc = $collectedClasses.Calculator_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure7.prototype = $desc;
  function Calculator_closure8(this_9) {
    this.this_9 = this_9;
  }
  Calculator_closure8.builtin$cls = "Calculator_closure8";
  if (!"name" in Calculator_closure8)
    Calculator_closure8.name = "Calculator_closure8";
  $desc = $collectedClasses.Calculator_closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_closure8.prototype = $desc;
  function Calculator_getQR_closure(this_0) {
    this.this_0 = this_0;
  }
  Calculator_getQR_closure.builtin$cls = "Calculator_getQR_closure";
  if (!"name" in Calculator_getQR_closure)
    Calculator_getQR_closure.name = "Calculator_getQR_closure";
  $desc = $collectedClasses.Calculator_getQR_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculator_getQR_closure.prototype = $desc;
  function Calculadora2(amount, img) {
    this.amount = amount;
    this.img = img;
  }
  Calculadora2.builtin$cls = "Calculadora2";
  if (!"name" in Calculadora2)
    Calculadora2.name = "Calculadora2";
  $desc = $collectedClasses.Calculadora2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculadora2.prototype = $desc;
  function Calculadora2_initted_closure(this_0, sqrl_1) {
    this.this_0 = this_0;
    this.sqrl_1 = sqrl_1;
  }
  Calculadora2_initted_closure.builtin$cls = "Calculadora2_initted_closure";
  if (!"name" in Calculadora2_initted_closure)
    Calculadora2_initted_closure.name = "Calculadora2_initted_closure";
  $desc = $collectedClasses.Calculadora2_initted_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calculadora2_initted_closure.prototype = $desc;
  function PartialLoader_getLoginPartial_closure(ele_0, cmpl_1) {
    this.ele_0 = ele_0;
    this.cmpl_1 = cmpl_1;
  }
  PartialLoader_getLoginPartial_closure.builtin$cls = "PartialLoader_getLoginPartial_closure";
  if (!"name" in PartialLoader_getLoginPartial_closure)
    PartialLoader_getLoginPartial_closure.name = "PartialLoader_getLoginPartial_closure";
  $desc = $collectedClasses.PartialLoader_getLoginPartial_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PartialLoader_getLoginPartial_closure.prototype = $desc;
  function PayPalManager(foroxxo) {
    this.foroxxo = foroxxo;
  }
  PayPalManager.builtin$cls = "PayPalManager";
  if (!"name" in PayPalManager)
    PayPalManager.name = "PayPalManager";
  $desc = $collectedClasses.PayPalManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PayPalManager.prototype = $desc;
  function PayPalManager_closure(this_0) {
    this.this_0 = this_0;
  }
  PayPalManager_closure.builtin$cls = "PayPalManager_closure";
  if (!"name" in PayPalManager_closure)
    PayPalManager_closure.name = "PayPalManager_closure";
  $desc = $collectedClasses.PayPalManager_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PayPalManager_closure.prototype = $desc;
  function PayPalManager_Tok3nVinculation_closure(this_0) {
    this.this_0 = this_0;
  }
  PayPalManager_Tok3nVinculation_closure.builtin$cls = "PayPalManager_Tok3nVinculation_closure";
  if (!"name" in PayPalManager_Tok3nVinculation_closure)
    PayPalManager_Tok3nVinculation_closure.name = "PayPalManager_Tok3nVinculation_closure";
  $desc = $collectedClasses.PayPalManager_Tok3nVinculation_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PayPalManager_Tok3nVinculation_closure.prototype = $desc;
  function LoginWindow() {
  }
  LoginWindow.builtin$cls = "LoginWindow";
  if (!"name" in LoginWindow)
    LoginWindow.name = "LoginWindow";
  $desc = $collectedClasses.LoginWindow;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LoginWindow.prototype = $desc;
  function LoginWindow_closure(this_0) {
    this.this_0 = this_0;
  }
  LoginWindow_closure.builtin$cls = "LoginWindow_closure";
  if (!"name" in LoginWindow_closure)
    LoginWindow_closure.name = "LoginWindow_closure";
  $desc = $collectedClasses.LoginWindow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LoginWindow_closure.prototype = $desc;
  function LoginWindow__closure(this_1, ele_2) {
    this.this_1 = this_1;
    this.ele_2 = ele_2;
  }
  LoginWindow__closure.builtin$cls = "LoginWindow__closure";
  if (!"name" in LoginWindow__closure)
    LoginWindow__closure.name = "LoginWindow__closure";
  $desc = $collectedClasses.LoginWindow__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LoginWindow__closure.prototype = $desc;
  function LoginWindow__closure0(this_3, ele_4) {
    this.this_3 = this_3;
    this.ele_4 = ele_4;
  }
  LoginWindow__closure0.builtin$cls = "LoginWindow__closure0";
  if (!"name" in LoginWindow__closure0)
    LoginWindow__closure0.name = "LoginWindow__closure0";
  $desc = $collectedClasses.LoginWindow__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LoginWindow__closure0.prototype = $desc;
  function LoginWindow_createAccount_closure(this_0, ele_1) {
    this.this_0 = this_0;
    this.ele_1 = ele_1;
  }
  LoginWindow_createAccount_closure.builtin$cls = "LoginWindow_createAccount_closure";
  if (!"name" in LoginWindow_createAccount_closure)
    LoginWindow_createAccount_closure.name = "LoginWindow_createAccount_closure";
  $desc = $collectedClasses.LoginWindow_createAccount_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LoginWindow_createAccount_closure.prototype = $desc;
  function ShowTok3nWindow(cmpl, client, script) {
    this.cmpl = cmpl;
    this.client = client;
    this.script = script;
  }
  ShowTok3nWindow.builtin$cls = "ShowTok3nWindow";
  if (!"name" in ShowTok3nWindow)
    ShowTok3nWindow.name = "ShowTok3nWindow";
  $desc = $collectedClasses.ShowTok3nWindow;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ShowTok3nWindow.prototype = $desc;
  function ShowTok3nWindow_complete_closure(this_0, response_1) {
    this.this_0 = this_0;
    this.response_1 = response_1;
  }
  ShowTok3nWindow_complete_closure.builtin$cls = "ShowTok3nWindow_complete_closure";
  if (!"name" in ShowTok3nWindow_complete_closure)
    ShowTok3nWindow_complete_closure.name = "ShowTok3nWindow_complete_closure";
  $desc = $collectedClasses.ShowTok3nWindow_complete_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ShowTok3nWindow_complete_closure.prototype = $desc;
  function MergeTok3nWindow(client, script) {
    this.client = client;
    this.script = script;
  }
  MergeTok3nWindow.builtin$cls = "MergeTok3nWindow";
  if (!"name" in MergeTok3nWindow)
    MergeTok3nWindow.name = "MergeTok3nWindow";
  $desc = $collectedClasses.MergeTok3nWindow;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MergeTok3nWindow.prototype = $desc;
  function MergeTok3nWindow_responded_closure() {
  }
  MergeTok3nWindow_responded_closure.builtin$cls = "MergeTok3nWindow_responded_closure";
  if (!"name" in MergeTok3nWindow_responded_closure)
    MergeTok3nWindow_responded_closure.name = "MergeTok3nWindow_responded_closure";
  $desc = $collectedClasses.MergeTok3nWindow_responded_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MergeTok3nWindow_responded_closure.prototype = $desc;
  ...
  function NumberFormat(_negativePrefix, _positivePrefix, _negativeSuffix, _positiveSuffix, _groupingSize, _finalGroupingSize, _groupingSizeSetExplicitly, _decimalSeparatorAlwaysShown, _useSignForPositiveExponent, _useExponentialNotation, maximumIntegerDigits, minimumIntegerDigits, maximumFractionDigits, minimumFractionDigits, minimumExponentDigits, _multiplier, _intl$_pattern, _locale, _symbols, currencyName, _intl$_buffer, _maxInt, _zero) {
