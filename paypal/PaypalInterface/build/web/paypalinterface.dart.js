...
["PaypalInterface", "package:PaypalInterface/paypalinterface.dart", , U, {
  "^": "",
  PartialLoader_getLoginPartial: function(ele) {
    ...
    W.HttpRequest_getString("partials/loginpartial.html", null, null).then$1(new U.PartialLoader_getLoginPartial_closure(ele, cmpl));
    return cmpl.future;
  },
  Calculator: {
    "^": "Object;text",
    ...
    getQR$1: [function(_) {
      W.HttpRequest_getString("/ws/setmonto?monto=" + H.S(J.get$value$x(this.text)), null, null).then$1(new U.Calculator_getQR_closure(this));
    }, "call$1", "get$getQR", 2, 0, 13, 38],
    cancel$1: [function(_) {
      J.set$value$x(this.text, "$0");
    }, "call$1", "get$cancel", 2, 0, 13, 38],
    Calculator$0: function() {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton1"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton2"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure1(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton3"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure2(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton4"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure3(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton5"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure4(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton6"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure5(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton7"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure6(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(t1.querySelector$1(div, "#boton8"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Calculator_closure7(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = J.get$onClick$x(t1.querySelector$1(div, "#boton9"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.Calculator_closure8(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {Calculator$: function() {
        var t1 = new U.Calculator(null);
        t1.Calculator$0();
        return t1;
      }}
  },
  ...
  Calculadora2: {
    ...
    initted$1: [function(response) {
      var t1, sqrl;
      t1 = J.$index$asx(C.JsonCodec_null_null.decode$1(response), "Tok3nKey");
      sqrl = new M.SQRL(false, "d550667e-a85b-5e95-5a93-cd0645853f6a", t1, "auth", null, null, null, null);
      sqrl.SQRL$3("d550667e-a85b-5e95-5a93-cd0645853f6a", t1, "auth");
      sqrl.init_doneC.future.then$1(new U.Calculadora2_initted_closure(this, sqrl));
      sqrl.qr_conectedC.future.then$1(this.get$validatedQR());
    }, "call$1", "get$initted", 2, 0, 13, 39],
    validatedQR$1: [function(response) {
      U.Calculator$();
    }, "call$1", "get$validatedQR", 2, 0, 13, 39],
  ...
  Calculadora2_initted_closure: {
    ...
    call$1: [function(_) {
      ...
      t2.cancelQR = false;
      t3 = t2.transactionID;
      url = $.Tok3n_V2_DOMAIN + "/api/v2/getQR?transaction=" + H.S(t3) + "&public_key=" + t2.publicKey;
      J.set$src$x(t1, url);
    }, "call$1", null, 2, 0, null, 38, "call"]
  },
  ...
  PayPalManager: {
    ...
    Tok3nVinculation$0: function() {
      W.HttpRequest_getString("/ws/userHasTok3n", null, null).then$1(new U.PayPalManager_Tok3nVinculation_closure(this));
    },
    showCalculator$1: [function(_) {
      U.Calculator$();
    }, "call$1", "get$showCalculator", 2, 0, 13, 38],
    PayPalManager$0: function() {
      W.HttpRequest_getString("/ws/isloggedin", null, null).then$1(new U.PayPalManager_closure(this));
    },
    static: {PayPalManager$: function() {
        var t1 = new U.PayPalManager();
        t1.PayPalManager$0();
        return t1;
      }}
  },
  ...
  PayPalManager_Tok3nVinculation_closure: {
    ...
    call$1: [function(resp) {
      var tok3n;
      if (J.$eq(resp, "YES")) {
        tok3n = new U.ShowTok3nWindow(null, null, null);
        tok3n.ShowTok3nWindow$0();
        tok3n.cmpl.future.then$1(this.this_0.get$showCalculator());
      } else
        new U.MergeTok3nWindow(null, null).MergeTok3nWindow$0();
    }, "call$1", null, 2, 0, null, 41, "call"]
  },
  LoginWindow: {
    "^": "Object;",
    createAccount$1: function(ele) {
      ...
      if (J.get$length$asx(t1.get$value(e)) > 3)
        W.HttpRequest_getString("/ws/create?user=" + H.S(t1.get$value(e)), null, null).then$1(new U.LoginWindow_createAccount_closure(this, ele));
    },
    ...
    }, "call$1", "get$loginAccount_response", 2, 0, 13, 39],
    LoginWindow$0: function() {
      P.print("init loginwindow");
      U.PartialLoader_getLoginPartial(document.querySelector("#container")).then$1(new U.LoginWindow_closure(this));
    },
    static: {LoginWindow$: function() {
        var t1 = new U.LoginWindow();
        t1.LoginWindow$0();
        return t1;
      }}
  },
  LoginWindow_closure: {
    ...
    call$1: [function(ele) {
      ...
      t3 = this.this_0;
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.LoginWindow__closure(t3, ele)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = J.get$onClick$x(t1.querySelector$1(ele, "#createbutton"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.LoginWindow__closure0(t3, ele)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  ShowTok3nWindow: {
    ...
    inited$1: [function(response) {
      ...
      t1 = new A.Tok3nClient("4c186122-ed23-5cf5-45c2-2e1a17639efa", null, document.querySelector("body"), null);
      this.client = t1;
      this.script = t1.askTok3n$1(J.$index$asx(data, "Tok3nKey"));
      this.client.responseC.future.then$1(this.get$complete(this));
    }, "call$1", "get$inited", 2, 0, 13, 39],
    complete$1: [function(_, response) {
      ...
      if (J.$eq(J.$index$asx(data, "Valid"), "YES"))
        W.HttpRequest_getString("/ws/authenticateuser?q=" + H.S(P.Uri__uriEncode(C.List_KIf, t1.get$detail(response), C.Utf8Codec_false, false)), null, null).then$1(new U.ShowTok3nWindow_complete_closure(this, response));
    }, "call$1", "get$complete", 2, 0, 13, 39],
  ...
  MergeTok3nWindow: {
    ...
    responded$1: [function(response) {
      ...
      P.print(data);
      if (J.$eq(J.$index$asx(data, "Valid"), "YES"))
        W.HttpRequest_getString("/ws/authenticateuser?q=" + H.S(P.Uri__uriEncode(C.List_KIf, t1.get$detail(response), C.Utf8Codec_false, false)), null, null).then$1(new U.MergeTok3nWindow_responded_closure());
    }, "call$1", "get$responded", 2, 0, 44, 39],
    MergeTok3nWindow$0: function() {
      P.print("start vinculation of tok3n");
      var t1 = new A.Tok3nClient("4c186122-ed23-5cf5-45c2-2e1a17639efa", null, document.querySelector("body"), null);
      this.client = t1;
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 58, 17, 18],
...
["tok3napi_dart", "package:Tok3nAPI_Dart/tok3napi_dart.dart", , M, {
  ...
  SQRL: {
    ...
    }, "call$1", "get$init_response", 2, 0, 68, 39],
...
$.Tok3n_V2_DOMAIN = "https://secure.tok3n.com";
